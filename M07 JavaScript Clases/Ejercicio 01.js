...
function agregarStringInvertida() {
   ...
   String.prototype.reverse = function() {
      ...
      for (let i = this.length - 1; i >= 0 ; i--) {
         stringInvertida.push(this.charAt(i))
      }
   return stringInvertida.join('')
   //creo la funcion reverse -> declaro la stringInvertida como una lista vacia -> 
   //recorro el string en reversa y pongo cada valor en la lista stringInvertida -> al  final retorno stringInvertida.join('') para juntar la lista
   }
}
