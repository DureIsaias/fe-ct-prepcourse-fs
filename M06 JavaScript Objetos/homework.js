...
function tieneEmail(objetoUsuario) {
   ...
   // Tu código:
   let email = objetoUsuario.email != null
   return email
}
...
function tienePropiedad(objeto, propiedad) {
   ...
   // En ese caso retornar true. Caso contrario, false.
   // Tu código:
   let tieneProp = objeto.hasOwnProperty(propiedad)
   return(tieneProp)
}
...
function actualizarPassword(objetoUsuario, nuevaPassword) {
   ...
   // Retornar el objeto.
   // Tu código:
   let nuevaContraseña = objetoUsuario.password = nuevaPassword
